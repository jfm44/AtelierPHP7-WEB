      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
                    ...
                    <form class="form-login" method="POST" action="front_controler.php?action=login_post" >
		        <h2 class="form-login-heading">Connectez-vous</h2>
		        <div class="login-wrap">
		            <input type="text" name="Login" value="Login" class="form-control" placeholder="User ID" autofocus>
		            <br>
		            <input type="password" name="mdp" value="mdp" class="form-control" placeholder="Password">
                            <br>
